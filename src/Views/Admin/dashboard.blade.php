            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50" src="{{asset('admin/img/avatar/avatar-1.png')}}"
                                alt="avatar">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50" src="{{asset('admin/img/avatar/avatar-2.png')}}"
                                alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50" src="{{asset('admin/img/avatar/avatar-3.png')}}"
                                alt="avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="mr-3 rounded-circle" width="50" src="{{asset('admin/img/avatar/avatar-4.png')}}"
                                alt="avatar">
                            <div class="media-body">
                    ...
                    <div class="row pb-2">
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="{{asset('admin/img/avatar/avatar-5.png')}}" class="img-fluid"
                        ...
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="{{asset('admin/img/avatar/avatar-4.png')}}" class="img-fluid"
                        ...
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="{{asset('admin/img/avatar/avatar-1.png')}}" class="img-fluid"
                        ...
                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                            <div class="avatar-item mb-0">
                                <img alt="image" src="{{asset('admin/img/avatar/avatar-2.png')}}" class="img-fluid"
                ...
                <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                        ...
                        <li class="media">
                            ...
                            <img class="mr-3 rounded-circle" width="50" src="{{asset('admin/img/avatar/avatar-5.png')}}"
                                alt="avatar">
                            <div class="media-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" class="font-weight-600"><img
                                                src="{{asset('admin/img/avatar/avatar-1.png')}}" alt="avatar" width="30"
