...
@section('main')
    <div id="carousel-home">
        <div class="owl-carousel owl-theme">
            <div class="owl-slide cover"
                 style="background-image: url('https://t4.ftcdn.net/jpg/03/83/21/85/360_F_383218557_t5fC98hOdrg0hr4BsulCZ9mPX9a4uube.jpg');">
            ...
            <!--/owl-slide-->
            <div class="owl-slide cover"
                 style="background-image: url('https://www.shutterstock.com/image-vector/ecommerce-website-banner-template-presents-260nw-2252124451.jpg');">
                <div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
                    <div class="container">
            ...
            <!--/owl-slide-->
            <div class="owl-slide cover"
                 style="background-image: url('https://t4.ftcdn.net/jpg/02/16/47/35/360_F_216473592_NefHePTpMfvYMNjD3UQTUVJy7DFPwqKA.jpg');">
    ...
    <ul id="banners_grid" class="clearfix">
        @foreach($categories as $category)
            <li>
                <a href="{{ routeClient('shops?c=' . $category['slug']) }}" class="img_container">
                    <img src="{{ routeClient($category['image']) }}" data-src="{{ routeClient($category['image']) }}"
                         alt="" class="lazy">
                ...
                <div class="col-6 col-md-4 col-xl-3">
                    <div class="grid_item">
                        <figure>
                            ...
                            @if($product['type'] == 1)
                                <div data-countdown="2024/6/12" class="countdown"></div>
                            @endif
                        </figure>
                        <div class="rating">
                        ...
                        <div class="price_box">
                            <span class="new_price">{{ formatPrice($product['price_offer'] ?: $product['price']) }}</span>
