...
{{--                                                <small>12</small>--}}
                ...
                <div class="col-lg-9">
                            ...
                            @foreach($products as $product)
                                ...
                                <div class="col-6 col-md-4">
                                    <div class="grid_item">
                                        ...
                                        @endif
                                        <figure>
                                            <a href="{{ routeClient('shop/' . $product['p_slug'] . '?id=' . $product['p_id']) }}">
                    ...
                    <div class="pagination__wrapper">
                        <ul class="pagination">
                            <li>
                                <a href="{{ $page > 1 ? routeClient($url . ($page - 1)) : routeClient($url . '1') }}" class="prev" title="previous page">&#10094;</a>
                            </li>
                            ...
                            <li>
                                <a href="{{ routeClient($url . ($page == $totalPage ? $page : $page + 1)) }}" class="next" title="next page">&#10095;</a>
                            </li>
                        </ul>
                    </div>
                </div>
